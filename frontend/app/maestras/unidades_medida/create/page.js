...
export default function CreateUnidadMedidaPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/core/unidades-medida/', formData, {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>
          <i className="fa fa-ruler" style={{ marginRight: '10px' }}></i>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={saving} style={{...styles.submitButton, opacity: saving ? 0.7 : 1}}>
            {saving ? (
              ...
              <span><i className="fa fa-save" style={{ marginRight: '8px' }}></i>Guardar Unidad</span>
            )}
          </button>
        </form>
      </div>
